...
#let user input hour: it has be vairable but put some words.
    elif send_message == "1" and isinstance(event.source, SourceUser):
        bubble_string = """
        {
  "type": "bubble",
  "body": {
...
"""
        message = FlexSendMessage(alt_text="1", contents=json.loads(bubble_string))
        line_bot_api.reply_message(
            event.reply_token,
            message
        )
...
#let user to choose task type: duration of task
    elif event.postback.data == "DurationDue=User=tap":
        line_bot_api.reply_message(
            event.reply_token,
...
"""
        message = FlexSendMessage(alt_text="duration", contents=json.loads(bubble_string))
        line_bot_api.reply_message(
            event.reply_token,
            message
        )
...
"""
        message2 = FlexSendMessage(alt_text="Confirm Task", contents=json.loads(bubble_string))
        line_bot_api.reply_message(
            event.reply_token,
            message2
        )
    elif event.postback.data == "cancel=user=task":
        bubble_string = """
{
  "type": "carousel",
  "contents": [
...
"""
        message = FlexSendMessage(alt_text="Cancel Task", contents=json.loads(bubble_string))
        line_bot_api.reply_message(
            event.reply_token,
            message
        )
#when user input view task or view list
    elif event.postback.data == "view=task=user":
        bubble_string = """
        {
  "type": "bubble",
  "body": {
            ...
            "contents": [
              {
                ...
                "action": {
                  "type": "postback",
                  "label": "extend 20minutes",
                  "data": "star=task=more20m",
              ...
              },
              {
                ...
                "action": {
                  "type": "postback",
                  "label": "Extend 40 minutes",
                  "data": "start=extend=40m",
          ...
          },
          {
            ...
            "contents": [
              ...
              },
              {
                ...
                "action": {
                  "type": "postback",
                  "label": "Extend due by nxt week",
                  "data": "extend=due=nextw",
...
"""
        message = FlexSendMessage(alt_text="View Task", contents=json.loads(bubble_string))
        line_bot_api.reply_message(
            event.reply_token,
            message
        )
...
"""
        message = FlexSendMessage(alt_text="View Task List", contents=json.loads(bubble_string))
        line_bot_api.reply_message(
            event.reply_token,
            message
        )
