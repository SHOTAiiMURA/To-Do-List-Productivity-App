...
from sql import insert_json_chooseDuration, choose_duration, choose_priority, insert_hour_duration
...
def handle_postback(event):
    ...
    # return priority
    elif event.postback.data == '0 minutes' or '15 minutes' or '25 minutes' or '45 minutes':
